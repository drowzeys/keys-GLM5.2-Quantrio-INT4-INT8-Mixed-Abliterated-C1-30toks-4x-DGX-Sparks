...
| `serve_speed1_standing.json` | Legacy SPEED=1 numbers (historical; not standing) |
| `refusal_probe_hybrid_l65_l30.json` | Legacy mild L65–77 probe (historical; not standing) |
